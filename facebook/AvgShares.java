...
public class AvgShares {
 
    public static class AvgSharesMapper extends MapReduceBase implements
	...
	public void map(Object key, Text value, OutputCollector<IntWritable, IntWritable> output, Reporter reporter) throws IOException {
    	...
    	public static void main(String args[]) throws Exception {
    		...
    		JobConf conf = new JobConf(AvgShares.class);
    		...
    		conf.setMapperClass(AvgSharesMapper.class);
    		conf.setReducerClass(AvgSharesReducer.class);
    		conf.setInputFormat(TextInputFormat.class);
    		conf.setOutputFormat(TextOutputFormat.class);
    		FileInputFormat.setInputPaths(conf, new Path(args[0]));
    		FileOutputFormat.setOutputPath(conf, new Path(args[1]));  // Only 1 o\p path, inputs paths can be many.
